...
./waf configure --prefix=/usr --enable-shlib --enable-python3-bindings --enable-examples --enable-can-socketcan --enable-rtable --enable-if-zmqhub --with-driver-usart=linux --with-os=posix --enable-promisc
